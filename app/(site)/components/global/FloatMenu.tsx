                        ...
                        {!isExpanded && (
                            <>
                                ...
                                >
                                    {/* Other menu items */}
                                    <li
                                        className={`md:px-10 px-2 py-2 rounded-lg hover:bg-white hover:text-black duration-300 ${pathname === '/about'
                                            ? 'bg-white text-black'
                                    ...
                                    <li
                                        className={`md:px-10 px-3 py-2  rounded-lg   hover:bg-white hover:text-black     duration-300 	${pathname == '/projects'
                                            ? 'bg-white text-black '
                                            : 'text-white bg-transparent'
                                            }
                        `}
